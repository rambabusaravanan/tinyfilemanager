...
if (isset($_SESSION[FM_SESSION_ID]['logged']) && !empty($directories_users[$_SESSION[FM_SESSION_ID]['logged']])) {
    ...
    $root_url =  $app_root.DIRECTORY_SEPARATOR.$directories_users[$_SESSION[FM_SESSION_ID]['logged']];
}
// clean $root_url
...
if (isset($_GET['settings']) && !FM_READONLY && false) {
    fm_show_header(); // HEADER
    fm_show_nav_path(FM_PATH); // current path
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'File Manager App';       $tr['en']['AppTitle']           = 'File Manager';
